				...
				<div class="sidebar-sticky">
					<ul class="nav flex-column">
						...
						<li class="nav-item"><a class="nav-link"
							href="/Admin/addProduct"> <span data-feather="file"></span>
								Add Orders
						</a></li>
						<li class="nav-item"><a class="nav-link"
							href="/Admin/getAllProduct"> <span
								data-feather="shopping-cart"></span> Products
						</a></li>
						<li class="nav-item"><a class="nav-link"
							href="/Admin/getAllCustomer"> <span data-feather="users"></span>
								Customers
						</a></li>
