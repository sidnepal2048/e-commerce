...
<link rel="stylesheet"
  ...
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="">My Store</a>
    ...
    <nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/Admin/getAllProduct">
              <span data-feather="shopping-cart"></span>
              Products
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/Admin/getAllCustomer">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <button class="btn btn-primary btn-lg btn-block" type="submit">Add Product</button>
				<a href="<c:url value="/Admin" />" class="btn btn-primary btn-lg btn-block">Cancel</a>
			</form:form>
		</div>
	</div>
